...
while(current_datetime <= end_datetime):
    ...
    if (current_datetime.month != last_datetime.month):
        ...
        pwr_results.to_csv(f'main/scenarios/results/wfa/pwr/wfa_pwr_{last_datetime.month}.csv', index=False)
        ch_results.to_csv(f'main/scenarios/results/wfa/ch/wfa_evch_{last_datetime.month}.csv', index=False)
