...
while(current_datetime <= end_datetime):
    ...
    if (current_datetime.month != last_datetime.month):
        ...
        pwr_results.to_csv(f'main/scenarios/results/s1/pwr/s1_pwr_{last_datetime.month}.csv', index=False)
        ch_results.to_csv(f'main/scenarios/results/s1/ch/s1_evch_{last_datetime.month}.csv', index=False)
