...
while(current_datetime <= end_datetime):
    ...
    if (current_datetime.month != last_datetime.month):
        ...
        pwr_results.to_csv(f'main/scenarios/results/s2/pwr/s2_pwr_{last_datetime.month}.csv', index=False)
        ch_results.to_csv(f'main/scenarios/results/s2/ch/s2_evch_{last_datetime.month}.csv', index=False)
