...
while(current_datetime <= end_datetime):
    ...
    if (current_datetime.month != last_datetime.month):
        ...
        pwr_results.to_csv(f'main/scenarios/results/s3/pwr/s3_pwr_{last_datetime.month}.csv', index=False)
        ch_results.to_csv(f'main/scenarios/results/s3/ch/s3_evch_{last_datetime.month}.csv', index=False)
