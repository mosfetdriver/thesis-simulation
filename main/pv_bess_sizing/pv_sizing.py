### SCENARIO: GRID - CS - EXTERNAL LOAD - WFA - PV ###
...
while(current_datetime <= end_datetime):
    ...
    if (current_datetime.month != last_datetime.month):
        ...
        pwr_results.to_csv(f'main/pv_bess_sizing/sizing_results/pv/n{n_pv}/pwr/n{n_pv}_pwr_{last_datetime.month}.csv', index=False)
        ch_results.to_csv(f'main/pv_bess_sizing/sizing_results/pv/n{n_pv}/ch/n{n_pv}_evch_{last_datetime.month}.csv', index=False)
