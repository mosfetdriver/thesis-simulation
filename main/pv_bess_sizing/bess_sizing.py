...
while(current_datetime <= end_datetime):
    ...
    ev_pwr = FCI_ChSt.wfa(ev_dem, ev_ch, ev_tin, ev_tout, p_load, p_res, current_datetime.timestamp(), 1)
    ...
    if (current_datetime.month != last_datetime.month):
        ...
        pwr_results.to_csv(f'main/pv_bess_sizing/sizing_results/bess/n{n_pv}_{bess_cap_kwh}kwh/pwr/n{n_pv}_{bess_cap_kwh}kwh_pwr_{last_datetime.month}.csv', index=False)
        ch_results.to_csv(f'main/pv_bess_sizing/sizing_results/bess/n{n_pv}_{bess_cap_kwh}kwh/ch/n{n_pv}_{bess_cap_kwh}kwh_evch_{last_datetime.month}.csv', index=False)
